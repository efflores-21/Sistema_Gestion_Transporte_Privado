...
In Sistema_Gestion_Transporte_Privado-labels_en.properties:
Sistema_Gestion_Transporte_Privado=My application
Sistema_Gestion_Transporte_Privado[description]=My application does this and that

In Sistema_Gestion_Transporte_Privado-messages_en.properties:
